...
function print_cp_login($mismatch = false)
{
	...
	<table class="tborder" cellpadding="0" cellspacing="0" border="0" width="450" align="center"><tr><td>
		...
		<!-- header -->
		<div class="tcat" style="padding:4px; text-align:center"><b><?php echo "WinxPortal&reg; Admin/Mod Sign On"; ?></b></div>
		<!-- /header -->
		...
		<tr valign="bottom">
			...
			<td>
				...
				// Create Custom Header Signature Bar
				<?php echo "WinxPortal&reg; Social Intranet Platform 10.2i"; ?><br />
				&nbsp;
			</td>
		</tr>
		<?php
